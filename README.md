...
Реализован компактный тёмный интерфейс: единая таблица и панель свойств,
сводка в строке состояния, синий акцент основного действия и цветные статусы
сроков. Форма создания открывается на месте панели свойств.
[Предпросмотр оформления](docs/design-preview.html) — автономный HTML-макет;
реальное приложение по-прежнему использует C++ и Win32.
[Проверки и ограничения](UI_REVIEW.md).
